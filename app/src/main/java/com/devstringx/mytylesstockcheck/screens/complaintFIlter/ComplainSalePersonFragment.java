...
import com.devstringx.mytylesstockcheck.databinding.FragmentComplainSalePersonBinding;
...
public class ComplainSalePersonFragment extends Fragment implements ResponseListner, NameListWithCheckboxAdapter.FilterCBSelected {
    FragmentComplainSalePersonBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding= DataBindingUtil.inflate(inflater,R.layout.fragment_complain_sale_person, container, false);
    ...
    private void setupAdapter() {
        RecyclerView recyclerView = binding.complaintSalesNameRv;
        adapter = new NameListWithCheckboxAdapter(getContext(),allOwnersList,this::onItemSelectedListner, Common.selectedComplaintSalesExeName);
    ...
    public void onItemSelectedListner(List<String> selected_items) {
        Common.selectedComplaintSalesExeName=selected_items;
