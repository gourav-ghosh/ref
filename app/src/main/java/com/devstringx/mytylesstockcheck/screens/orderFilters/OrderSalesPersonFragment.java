...
import com.devstringx.mytylesstockcheck.databinding.FragmentOrderSalesPersonBinding;
...
public class OrderSalesPersonFragment extends Fragment implements ResponseListner , NameListWithCheckboxAdapter.FilterCBSelected{
    FragmentOrderSalesPersonBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding= DataBindingUtil.inflate(inflater,R.layout.fragment_order_sales_person, container, false);
    ...
    private void setupAdapter() {
        RecyclerView recyclerView = binding.orderFilterSalesExeRv;
        adapter = new NameListWithCheckboxAdapter(getContext(),allOwnersList,this::onItemSelectedListner, new ArrayList<>(Common.selectedOrderSupExeName));
    ...
    public void onItemSelectedListner(List<String> selected_items) {
        Common.tempSelectedOrderSupExeName=selected_items;
