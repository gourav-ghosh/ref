...
import com.devstringx.mytylesstockcheck.databinding.FragmentPOCodesBinding;
...
public class POCodesFragment extends Fragment implements ResponseListner , NameListWithCheckboxAdapter.FilterCBSelected {
    FragmentPOCodesBinding binding ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding= DataBindingUtil.inflate(inflater,R.layout.fragment_p_o_codes, container, false);
    ...
    private void setupAdapter() {
        RecyclerView recyclerView = binding.orderFilterPoCodesRv;
        adapter = new NameListWithCheckboxAdapter(getContext(),allOwnersList,this::onItemSelectedListner, new ArrayList<>(Common.selectedPOCodes));
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(adapter);
    }

    private void getPOCodes() {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("filter_value", "poCodes");
    ...
    public void onItemSelectedListner(List<String> selected_items) {
        Common.tempSelectedPOCodes=selected_items;
