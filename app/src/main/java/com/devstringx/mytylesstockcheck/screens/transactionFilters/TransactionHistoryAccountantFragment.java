...
public class TransactionHistoryAccountantFragment extends Fragment implements ResponseListner, NameListWithCheckboxAdapter.FilterCBSelected {
    ...
    private void getUsersByRoleName() {
        ...
        try {
            jsonObject.put("role_name", "Account Manager");
    ...
    private void setupAdapter() {
        ...
        adapter = new NameListWithCheckboxAdapter(getContext(),allOwnersList,this::onItemSelectedListner, new ArrayList<>(Common.transactionAccountant));
    ...
    public void onItemSelectedListner(List<String> selected_items) {
        Common.tempTransactionAccountant=selected_items;
