...
import com.devstringx.mytylesstockcheck.databinding.FragmentOrderDeliveryAgentBinding;
...
public class OrderDeliveryAgentFragment extends Fragment implements ResponseListner,NameListWithCheckboxAdapter.FilterCBSelected {
    FragmentOrderDeliveryAgentBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_order_delivery_agent, container, false);
    ...
    private void setupAdapter() {
        RecyclerView recyclerView = binding.orderFilterDeliveryAgentRv;
        adapter = new NameListWithCheckboxAdapter(getContext(),allOwnersList,this::onItemSelectedListner,new ArrayList<>(Common.selectedOrderDeliveryAgentName));
    ...
    public void onItemSelectedListner(List<String> selected_items) {
        Common.tempSelectedOrderDeliveryAgentName=selected_items;
