...
import com.devstringx.mytylesstockcheck.databinding.FragmentDisManagerBinding;
...
public class DisManagerFragment extends Fragment implements ResponseListner,NameListWithCheckboxAdapter.FilterCBSelected {
    FragmentDisManagerBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_dis_manager, container, false);
    ...
    private void setupAdapter() {
        RecyclerView recyclerView = binding.orderDisManagerRv;
        adapter = new NameListWithCheckboxAdapter(getContext(),allOwnersList,this::onItemSelectedListner, new ArrayList<>(Common.selectedOrderDisManagerName));
    ...
    public void onItemSelectedListner(List<String> selected_items) {
        Common.tempSelectedOrderDisManagerName=selected_items;
