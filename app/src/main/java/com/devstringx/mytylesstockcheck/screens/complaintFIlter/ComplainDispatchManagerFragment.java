...
import com.devstringx.mytylesstockcheck.databinding.FragmentComplainDispatchManagerBinding;
...
public class ComplainDispatchManagerFragment extends Fragment implements ResponseListner, NameListWithCheckboxAdapter.FilterCBSelected {
    FragmentComplainDispatchManagerBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding= DataBindingUtil.inflate(inflater,R.layout.fragment_complain_dispatch_manager, container, false);
    ...
    private void setupAdapter() {
        RecyclerView recyclerView = binding.complaintDisNameRv;
        adapter = new NameListWithCheckboxAdapter(getContext(),allOwnersList,this::onItemSelectedListner, Common.selectedComplaintDisName);
    ...
    public void onItemSelectedListner(List<String> selected_items) {
        Common.selectedComplaintDisName=selected_items;
